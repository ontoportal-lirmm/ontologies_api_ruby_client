...
module LinkedData
  module Client
    module ReadWrite
      ...
      def update(options = {})
        begin
          # LOGGER.debug("ONTOLOGIES_API_RUBY_CLIENT: LinkedData::Client::ReadWrite -> update options:#{options.inspect}")
          values = options[:values] || changed_values()
          # LOGGER.debug("\n\n    > values=#{values.inspect}")
          return if values.empty?
          # LOGGER.debug("\n\n    > BEFORE CALL HTTP.patch")
      ...
      def update_from_params(params)
        ...
        # LOGGER.debug("ONTOLOGIES_API_RUBY_CLIENT: LinkedData::Client::ReadWrite -> update_from_params(params) :\n\n params=#{params.inspect}\n\n all_values=#{all_values.inspect}")
      ...
      def changed_values
        begin
          ...
          self.instance_variables.each do |var|
            # LOGGER.debug("    => var=#{var}   >>> CALL equivalent");
